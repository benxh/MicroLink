...
#define BOARD_RE_EN_GPIO_CTRL  HPM_GPIO0
#define BOARD_RE_EN_GPIO_INDEX GPIO_DI_GPIOB
#define BOARD_RE_EN_GPIO_PIN   10

/* User LED */
#define BOARD_LED_USB_IN_GPIO_CTRL  HPM_GPIO0
#define BOARD_LED_USB_IN_GPIO_INDEX GPIO_DI_GPIOB
#define BOARD_LED_USB_IN_GPIO_PIN   13

#define BOARD_LED_USB_OUT_GPIO_CTRL  HPM_GPIO0
#define BOARD_LED_USB_OUT_GPIO_INDEX GPIO_DI_GPIOB
#define BOARD_LED_USB_OUT_GPIO_PIN   12
